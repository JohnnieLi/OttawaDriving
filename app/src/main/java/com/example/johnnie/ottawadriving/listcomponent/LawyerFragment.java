 ...
 * {@link LawyerFragment.OnLawyerFragmentInteractionListener} interface
...
public class LawyerFragment extends Fragment {
    ...
    private OnLawyerFragmentInteractionListener mListener;
     ...
     */
    public static LawyerFragment newInstance(String title) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_lawyer_page, container, false);
...
//    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnLawyerFragmentInteractionListener) {
            mListener = (OnLawyerFragmentInteractionListener) context;
        } else {
     ...
     */
    public interface OnLawyerFragmentInteractionListener {
        void onLawyerFragmentInteraction(Uri uri);
    }
}