...
public class DealerFragment extends Fragment {
    ...
    private OnDealerFragmentInteractionListener mCallbacks;
    ...
    /**
     * Create a new instance of DealerFragment, providing "title"
     * as an argument.
     */
    public static DealerFragment newInstance(String title) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_dealer_page, container, false);
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mCallbacks = (OnDealerFragmentInteractionListener) activity;
